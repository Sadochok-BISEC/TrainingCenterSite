...
let virtual-env = "D:\Для Баргу\Курсачи\МиниКурсовая работа ПЗ\web-app\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Для Баргу\Курсачи\МиниКурсовая работа ПЗ\web-app\venv\Scripts\deactivate.nu"
